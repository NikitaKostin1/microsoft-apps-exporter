...
func NewListItemsWithDeltaOptions(expandFields []string) *graphsites.ItemListsItemItemsDeltaRequestBuilderGetRequestConfiguration {
	expandString := "fields"
